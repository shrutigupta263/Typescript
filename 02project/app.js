...
var WeatherApp = /** @class */ (function () {
    function WeatherApp() {
        ...
        this.searchBtn.addEventListener('click', function () { return _this.getWeather(); });
    }
    ...
    WeatherApp.prototype.displayWeather = function (data) {
        ...
        this.weatherInfo.innerHTML = "\n            <h2>".concat(name, "</h2>\n            <p>Temperature: ").concat(main.temp, "\u00B0C</p>\n            <p>Humidity: ").concat(main.humidity, "%</p>\n            <p>Weather: ").concat(weather[0].description, "</p>\n        ");
    };
    return WeatherApp;
}());
new WeatherApp();
